        ...
        if (isset($_POST['submit'])) {
            ...
            if ($errors == false) {
                ...
                if ($result) {
                    ...
                    $adminEmail = 'girevik1988@gmail.com';
                    // $message = 'http://originalshop.uxp.ru/admin/order';
                    $subject = 'Новый заказ! от' . '$userName';
                    mail($adminEmail, $subject, $userComment, $userPhone);
                    // Очищаем корзину
                    Cart::clear();
                }
            }
